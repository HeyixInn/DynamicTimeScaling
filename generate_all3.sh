...
CUDA_VISIBLE_DEVICES=4 python generate.py --model_id=4 --temperature=0 --data_name=openaimath&
CUDA_VISIBLE_DEVICES=7 python generate.py --model_id=6 --temperature=0 --data_name=aime&
wait
CUDA_VISIBLE_DEVICES=3 python generate.py --model_id=6 --temperature=0 --data_name=gpqa&
